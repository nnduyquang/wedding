<div class="modal fade" id="submit-confirm-update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer" style="margin-top: 50px">
                <div class="col-md-12">
                    <input type="hidden" name="idService" value="{{old('srcIcon')}}">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                    <button id="updateService" class="btn btn-primary">Cập Nhật</button>
                </div>
            </div>
        </div>
    </div>
